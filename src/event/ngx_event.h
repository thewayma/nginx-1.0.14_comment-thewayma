...
#define ngx_recv             ngx_io.recv            /*ngx_unix_recv*/
#define ngx_recv_chain       ngx_io.recv_chain      /*ngx_readv_chain*/
#define ngx_udp_recv         ngx_io.udp_recv        /*ngx_udp_unix_recv*/
#define ngx_send             ngx_io.send            /*ngx_unix_send*/
#define ngx_send_chain       ngx_io.send_chain      /*ngx_linux_sendfile_chain*/
